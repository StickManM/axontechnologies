...
public class ModRecipeProvider extends FabricRecipeProvider {
    private static final List<ItemConvertible> MIMICARIUM_SMELTABLES = List.of(ModBlocks.MIMICARIUM_ORE, ModBlocks.DEEPSLATE_MIMICARIUM_ORE);
    private static final List<ItemConvertible> THUNDERANIUM_SMELTABLES = List.of(ModBlocks.THUNDERANIUM_ORE, ModBlocks.DREADSTONE_THUNDERANIUM_ORE);
    ...
    public void generate(RecipeExporter exporter) {
        ...
        offerSmelting(exporter, THUNDERANIUM_SMELTABLES, RecipeCategory.MISC, ModItems.REFINED_THUNDERANIUM,
                5f, 75, "thunderanium");
        ...
        offerBlasting(exporter, List.of(ModBlocks.DREADSTONE_DIAMOND_ORE), RecipeCategory.MISC, Items.DIAMOND,
                3f, 75, "diamond");

        offerBlasting(exporter, List.of(ModBlocks.DREADSTONE_NETHERITE_ORE), RecipeCategory.MISC, Items.NETHERITE_INGOT,
                3f, 75, "netherite");

        offerBlasting(exporter, List.of(ModBlocks.VOID_COAL_ORE), RecipeCategory.MISC, ModItems.VOID_COAL,
                3f, 75, "void_coal");

        offerBlasting(exporter, List.of(ModItems.RAW_NETHERITE), RecipeCategory.MISC, Items.NETHERITE_INGOT,
                3f, 75, "netherite");

        offerBlasting(exporter, THUNDERANIUM_SMELTABLES, RecipeCategory.MISC, ModItems.REFINED_THUNDERANIUM,
                5f, 75, "thunderanium");

        offerBlasting(exporter, List.of(ModBlocks.CORRUPTINITE_ORE), RecipeCategory.MISC, ModItems.UNSTABLE_CORRUPTINITE,
                5f, 75, "corruptinite");

        offerBlasting(exporter, List.of(ModBlocks.RENDERIUM_ORE), RecipeCategory.MISC, ModItems.RENDERIUM,
                5f, 75, "renderium");

        offerBlasting(exporter, List.of(ModBlocks.DENDERIUM_ORE), RecipeCategory.MISC, ModItems.DENDERIUM,
                5f, 75, "denderium");
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.REDSTONE, Items.HOPPER)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(Items.HOPPER)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModBlocks.REINFORCED_DREADSTONE)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModBlocks.REINFORCED_DREADSTONE)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModBlocks.REINFORCED_DREADSTONE_GLASS)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModBlocks.REINFORCED_DREADSTONE_GLASS)));
        ...
        createDoorRecipe(ModBlocks.REINFORCED_DREADSTONE_DOOR, Ingredient.ofItems(ModBlocks.REINFORCED_DREADSTONE))
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModBlocks.REINFORCED_DREADSTONE_DOOR)));
        ...
        createTrapdoorRecipe(ModBlocks.REINFORCED_DREADSTONE_TRAPDOOR, Ingredient.ofItems(ModBlocks.REINFORCED_DREADSTONE))
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModBlocks.REINFORCED_DREADSTONE_TRAPDOOR)));
        ...
        createStairsRecipe(ModBlocks.REINFORCED_DREADSTONE_STAIRS, Ingredient.ofItems(ModBlocks.REINFORCED_DREADSTONE))
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModBlocks.REINFORCED_DREADSTONE_STAIRS)));
        ...
        createSlabRecipe(RecipeCategory.MISC, ModBlocks.REINFORCED_DREADSTONE_SLAB, Ingredient.ofItems(ModBlocks.REINFORCED_DREADSTONE_SLAB))
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModBlocks.REINFORCED_DREADSTONE_SLAB)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModBlocks.REINFORCED_DREADSTONE_WALL, 6)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModBlocks.REINFORCED_DREADSTONE_WALL)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModBlocks.THUNDERED_WOOD)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModBlocks.THUNDERED_WOOD)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.MIMICARIUM_IGNITER)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.MIMICARIUM_IGNITER)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.DREADED_IGNITER)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.DREADED_IGNITER)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.THUNDERANIUM_KEY)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.THUNDERANIUM_KEY)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.CORRUPTION_GATEWAY)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.CORRUPTION_GATEWAY)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModBlocks.MIMIMCARIUM_PORTAL_FRAME)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModBlocks.MIMIMCARIUM_PORTAL_FRAME)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModBlocks.THUNDERANIUM_PORTAL_FRAME)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModBlocks.THUNDERANIUM_PORTAL_FRAME)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModBlocks.CORRUPTION_PORTAL_FRAME)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModBlocks.CORRUPTION_PORTAL_FRAME)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.RED_THUNDERANIUM_CLUSTER)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.RED_THUNDERANIUM_CLUSTER)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.THUNDERANIUM_CLUSTER)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.THUNDERANIUM_CLUSTER)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.DARK_THUNDERANIUM_CLUSTER)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.DARK_THUNDERANIUM_CLUSTER)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.CORRUPTINITE)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.CORRUPTINITE)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.AXON_ALLOY)
                ...
                .criterion(FabricRecipeProvider.hasItem(ModItems.DARK_THUNDERANIUM_INGOT),
                        FabricRecipeProvider.conditionsFromItem(ModItems.AXON_ALLOY))
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.AXON_ALLOY)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.RAZZOR)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.RAZZOR)));
        ...
        ShapelessRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.TICKLE_TRAVIS_TICKLER)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.TICKLE_TRAVIS_TICKLER)));

        ShapelessRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.BOMB_STICK)
                .input(ModItems.RAZZOR)
                .input(Blocks.TNT, 4)
                .criterion(FabricRecipeProvider.hasItem(ModItems.RAZZOR),
                        FabricRecipeProvider.conditionsFromItem(ModItems.BOMB_STICK))
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.BOMB_STICK)));

        ShapelessRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.NEMESIS_COMMANDO_BLADE)
                .input(ModItems.RAZZOR)
                .input(ModItems.NATEY_GIFT)
                .criterion(FabricRecipeProvider.hasItem(ModItems.RAZZOR),
                        FabricRecipeProvider.conditionsFromItem(ModItems.NEMESIS_COMMANDO_BLADE))
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.NEMESIS_COMMANDO_BLADE)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.NOKIA_HAMMER)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.NOKIA_HAMMER)));
        ...
        ShapelessRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.NATEY_GIFT)
                ...
                .criterion(FabricRecipeProvider.hasItem(ModBlocks.OCTUPLE_COMPRESSED_COBBLESTONE),
                        FabricRecipeProvider.conditionsFromItem(ModItems.NATEY_GIFT))
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.NATEY_GIFT)));

        ShapelessRecipeJsonBuilder.create(RecipeCategory.MISC, ModBlocks.OCTUPLE_COMPRESSED_COBBLESTONE)
                .input(ModItems.OCTUPLE_COMPRESSED_STICK)
                .input(ModItems.NATEY_BALLS)
                .criterion(FabricRecipeProvider.hasItem(ModItems.OCTUPLE_COMPRESSED_STICK),
                        FabricRecipeProvider.conditionsFromItem(ModBlocks.OCTUPLE_COMPRESSED_COBBLESTONE))
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModBlocks.OCTUPLE_COMPRESSED_COBBLESTONE)));
        ...
        ShapelessRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.RED_ESSENCE, 12)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.RED_ESSENCE)));
        ...
        ShapelessRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.DARK_ESSENCE, 12)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.DARK_ESSENCE)));
        ...
        ShapelessRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.THUNDER_FUEL, 2)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.THUNDER_FUEL)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModBlocks.VOID_COAL_BLOCK)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModBlocks.VOID_COAL_BLOCK)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.RED_THUNDERANIUM_HELMET)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.RED_THUNDERANIUM_HELMET)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.RED_THUNDERANIUM_CHESTPLATE)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.RED_THUNDERANIUM_CHESTPLATE)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.RED_THUNDERANIUM_LEGGINGS)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.RED_THUNDERANIUM_LEGGINGS)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.RED_THUNDERANIUM_BOOTS)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.RED_THUNDERANIUM_BOOTS)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.DARK_THUNDERANIUM_HELMET)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.DARK_THUNDERANIUM_HELMET)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.DARK_THUNDERANIUM_CHESTPLATE)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.DARK_THUNDERANIUM_CHESTPLATE)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.DARK_THUNDERANIUM_LEGGINGS)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.DARK_THUNDERANIUM_LEGGINGS)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.DARK_THUNDERANIUM_BOOTS)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.DARK_THUNDERANIUM_BOOTS)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.CORRUPTINITE_HELMET)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.CORRUPTINITE_HELMET)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.CORRUPTINITE_CHESTPLATE)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.CORRUPTINITE_CHESTPLATE)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.CORRUPTINITE_LEGGINGS)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.CORRUPTINITE_LEGGINGS)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.CORRUPTINITE_BOOTS)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.CORRUPTINITE_BOOTS)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.DARK_THUNDERANIUM_AXON_ALLOY_HELMET)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.DARK_THUNDERANIUM_AXON_ALLOY_HELMET)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.DARK_THUNDERANIUM_AXON_ALLOY_CHESTPLATE)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.DARK_THUNDERANIUM_AXON_ALLOY_CHESTPLATE)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.DARK_THUNDERANIUM_AXON_ALLOY_LEGGINGS)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.DARK_THUNDERANIUM_AXON_ALLOY_LEGGINGS)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.DARK_THUNDERANIUM_AXON_ALLOY_BOOTS)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.DARK_THUNDERANIUM_AXON_ALLOY_BOOTS)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.CORRUPTINITE_AXON_ALLOY_HELMET)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.CORRUPTINITE_AXON_ALLOY_HELMET)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.CORRUPTINITE_AXON_ALLOY_CHESTPLATE)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.CORRUPTINITE_AXON_ALLOY_CHESTPLATE)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.CORRUPTINITE_AXON_ALLOY_LEGGINGS)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.CORRUPTINITE_AXON_ALLOY_LEGGINGS)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.CORRUPTINITE_AXON_ALLOY_BOOTS)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.CORRUPTINITE_AXON_ALLOY_BOOTS)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.AXON_ALLOY_HELMET)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.AXON_ALLOY_HELMET)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.AXON_ALLOY_CHESTPLATE)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.AXON_ALLOY_CHESTPLATE)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.AXON_ALLOY_LEGGINGS)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.AXON_ALLOY_LEGGINGS)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.AXON_ALLOY_BOOTS)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.AXON_ALLOY_BOOTS)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.ANTIGLITCH_SWORD)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.ANTIGLITCH_SWORD)));
        ...
        ShapelessRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.VANILLA_HOE)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.VANILLA_HOE)));
        ...
        ShapelessRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.ULTIMATE_HOE_TROPHY)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.ULTIMATE_HOE_TROPHY)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.THUNDERANIUM_SWORD)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.THUNDERANIUM_SWORD)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.THUNDERANIUM_PICKAXE)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.THUNDERANIUM_PICKAXE)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.THUNDERANIUM_SHOVEL)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.THUNDERANIUM_SHOVEL)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.THUNDERANIUM_AXE)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.THUNDERANIUM_AXE)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.THUNDERANIUM_HOE)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.THUNDERANIUM_HOE)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.RED_THUNDERANIUM_SWORD)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.RED_THUNDERANIUM_SWORD)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.RED_THUNDERANIUM_PICKAXE)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.RED_THUNDERANIUM_PICKAXE)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.RED_THUNDERANIUM_SHOVEL)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.RED_THUNDERANIUM_SHOVEL)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.RED_THUNDERANIUM_AXE)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.RED_THUNDERANIUM_AXE)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.RED_THUNDERANIUM_HOE)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.RED_THUNDERANIUM_HOE)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.DARK_THUNDERANIUM_SWORD)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.DARK_THUNDERANIUM_SWORD)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.DARK_THUNDERANIUM_PICKAXE)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.DARK_THUNDERANIUM_PICKAXE)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.DARK_THUNDERANIUM_SHOVEL)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.DARK_THUNDERANIUM_SHOVEL)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.DARK_THUNDERANIUM_AXE)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.DARK_THUNDERANIUM_AXE)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.DARK_THUNDERANIUM_HOE)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.DARK_THUNDERANIUM_HOE)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.CORRUPTINITE_SWORD)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.CORRUPTINITE_SWORD)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.CORRUPTINITE_PICKAXE)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.CORRUPTINITE_PICKAXE)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.CORRUPTINITE_SHOVEL)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.CORRUPTINITE_SHOVEL)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.CORRUPTINITE_AXE)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.CORRUPTINITE_AXE)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.CORRUPTINITE_HOE)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.CORRUPTINITE_HOE)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.DARK_THUNDERANIUM_AXON_ALLOY_SWORD)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.DARK_THUNDERANIUM_AXON_ALLOY_SWORD)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.DARK_THUNDERANIUM_AXON_ALLOY_AXE)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.DARK_THUNDERANIUM_AXON_ALLOY_AXE)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.DARK_THUNDERANIUM_AXON_ALLOY_PICKAXE)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.DARK_THUNDERANIUM_AXON_ALLOY_PICKAXE)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.DARK_THUNDERANIUM_AXON_ALLOY_SHOVEL)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.DARK_THUNDERANIUM_AXON_ALLOY_SHOVEL)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.DARK_THUNDERANIUM_AXON_ALLOY_HOE)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.DARK_THUNDERANIUM_AXON_ALLOY_HOE)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.CORRUPTINITE_AXON_ALLOY_SWORD)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.CORRUPTINITE_AXON_ALLOY_SWORD)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.CORRUPTINITE_AXON_ALLOY_AXE)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.CORRUPTINITE_AXON_ALLOY_AXE)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.CORRUPTINITE_AXON_ALLOY_PICKAXE)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.CORRUPTINITE_AXON_ALLOY_PICKAXE)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.CORRUPTINITE_AXON_ALLOY_SHOVEL)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.CORRUPTINITE_AXON_ALLOY_SHOVEL)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.CORRUPTINITE_AXON_ALLOY_HOE)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.CORRUPTINITE_AXON_ALLOY_HOE)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.AXON_ALLOY_SWORD)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.AXON_ALLOY_SWORD)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.AXON_ALLOY_AXE)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.AXON_ALLOY_AXE)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.AXON_ALLOY_PICKAXE)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.AXON_ALLOY_PICKAXE)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.AXON_ALLOY_SHOVEL)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.AXON_ALLOY_SHOVEL)));
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.AXON_ALLOY_HOE)
                ...
                .offerTo(exporter, Identifier.of(FabricRecipeProvider.getRecipeName(ModItems.AXON_ALLOY_HOE)));
