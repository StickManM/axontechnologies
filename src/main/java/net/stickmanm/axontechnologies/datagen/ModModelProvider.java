...
public class ModModelProvider extends FabricModelProvider {
    ...
    public void generateBlockStateModels(BlockStateModelGenerator blockStateModelGenerator) {
        ...
        blockStateModelGenerator.registerCubeAllModelTexturePool(ModBlocks.OCTUPLE_COMPRESSED_COBBLESTONE);
    ...
    public void generateItemModels(ItemModelGenerator itemModelGenerator) {
        ...
        itemModelGenerator.register(ModItems.NATEY_GIFT, Models.GENERATED);
        itemModelGenerator.register(ModItems.NATEY_BALLS, Models.GENERATED);
        ...
        itemModelGenerator.register(ModItems.NEMESIS_COMMANDO_BLADE, Models.HANDHELD);
        itemModelGenerator.register(ModItems.NOKIA_HAMMER, Models.HANDHELD);
        itemModelGenerator.register(ModItems.BOMB_STICK, Models.HANDHELD);
        itemModelGenerator.register(ModItems.TICKLE_TRAVIS_TICKLER, Models.HANDHELD);
        itemModelGenerator.register(ModItems.RAZZORIUM_PICKAXE, Models.HANDHELD);
