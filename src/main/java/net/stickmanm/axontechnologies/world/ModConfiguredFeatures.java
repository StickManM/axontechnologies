...
public class ModConfiguredFeatures {
    ...
    public static void bootstrap(Registerable<ConfiguredFeature<?, ?>> context) {
        //Rules
        RuleTest mimicariumStoneReplaceables = new TagMatchRuleTest(ModTagList.Blocks.MIMICARIUM_REPLACEABLE_STONE);
        RuleTest mimicariumDeepslateReplaceables = new TagMatchRuleTest(ModTagList.Blocks.MIMICARIUM_REPLACEABLE_DEEPSLATE);
        RuleTest fakeslate = new TagMatchRuleTest(ModTagList.Blocks.FAKESLATE_REPLACEABLE);
        RuleTest fakestone = new TagMatchRuleTest(ModTagList.Blocks.FAKESTONE_REPLACEABLE);
        RuleTest dreadCaverns = new TagMatchRuleTest(ModTagList.Blocks.DREADSTONE_REPLACEABLE);
        RuleTest thunderlands = new TagMatchRuleTest(ModTagList.Blocks.THUNDERED_STONE_REPLACEABLE);
        RuleTest corruptionlands = new TagMatchRuleTest(ModTagList.Blocks.CORRUPTED_STONE_REPLACEABLE);
        RuleTest voidstoneReplaceable = new TagMatchRuleTest(ModTagList.Blocks.VOIDSTONE_REPLACEABLE);
    ...
    private static RegistryKey<ConfiguredFeature<?, ?>> registerKey(String name) {
        return RegistryKey.of(RegistryKeys.CONFIGURED_FEATURE, AxonTechnologies.id(name));
    }
